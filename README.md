## bno055 (jazzy) - 0.5.0-4

The packages in the `bno055` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy bno055 --override-release-repository-push-url git@github.com:revyos-ros/bno055-release.git` on `Sat, 15 Jun 2024 04:24:11 -0000`
...
- release repository: https://github.com/revyos-ros/bno055-release.git
